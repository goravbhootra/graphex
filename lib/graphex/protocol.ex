defmodule Graphex.Protocol do
  @moduledoc false

  alias Graphex.{Adapter, Error, Type, Query}
  alias Graphex.Api.TxnContext
  ...
  defp get_adapter(:grpc), do: Graphex.Adapters.GRPC
  defp get_adapter(:http), do: Graphex.Adapters.HTTP

defmodule Graphex.Type.Mutation do
  @moduledoc false

  alias Graphex.{Adapter, Query, Utils}
  alias Graphex.Api.{Response, Mutation, Request}
  ...
  @impl true
  def decode(
        %Query{statement: statement, json: json_lib, type: Graphex.Type.Mutation} = _query,

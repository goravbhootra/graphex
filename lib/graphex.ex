defmodule Graphex do
  ...
  ## Example of usage
      ...
      iex> {:ok, conn} = Graphex.start_link()
      {:ok, #PID<0.216.0>}
  """
  @spec start_link(Keyword.t()) :: {:ok, pid} | {:error, Graphex.Error.t() | term}
  def start_link(opts \\ []) do
    opts = default_opts(opts)
    DBConnection.start_link(Graphex.Protocol, opts)
  end
  ...
  defp json_library(), do: Application.get_env(:graphex, :json_library, Jason)
  ...
  def child_spec(opts) do
    opts = default_opts(opts)
    DBConnection.child_spec(Graphex.Protocol, opts)
  end
  ...
  Example
      ...
      iex> Graphex.alter(conn, "name: string @index(term) .")
      {:ok, ""}
  ...
  """
  @spec alter(conn, iodata | map, Keyword.t()) :: {:ok, map} | {:error, Graphex.Error.t() | term}
  ...
  @spec set(conn, query_map, statement, Keyword.t()) ::
          {:ok, map} | {:error, Graphex.Error.t() | term}
  def set(conn, query, statement, opts), do: mutate(conn, query, %{set: statement}, opts)

  @doc """
  The same as `Graphex.set(conn, "", statement, [])`
  """
  @spec set(conn, statement) :: {:ok, map} | {:error, Graphex.Error.t() | term}
  def set(conn, statement), do: mutate(conn, %{}, %{set: statement}, [])

  @doc """
  The same as `Graphex.set(conn, "", statement, opts)`.
  """
  ...
  @doc """
  Runs a mutation and returns the result or raises `Graphex.Error` if there was an error.
  See `set/4`.
  """
  ...
  Example of usage
      ...
      iex> mutation = "
           ...
           _:foo <owns> _:bar .
            _:bar <name> "Bar" .
           "
      iex> Graphex.mutate(conn, %{set: mutation})
      {:ok, %{uids: %{"bar" => "0xfe04c", "foo" => "0xfe04b"}, queries: %{}}}

  Using `json`

      iex> json = %{"name" => "Foo", "owns" => [%{"name" => "Bar"}]}
           Graphex.mutate(conn, %{set: json})
      {:ok, %{uids: %{"blank-0" => "0xfe04d", "blank-1" => "0xfe04e"}, queries: %{}}}
      iex> Graphex.mutate(conn, %{set: json}, return_json: true)
      {:ok,
       %{json: %{
         "name" => "Foo",
         "owns" => [%{"name" => "Bar", "uid" => "0xfe050"}],
  ...
  @doc """
  The same as `Graphex.mutate(conn, "", mutations, [])`
  """
  @spec mutate(conn, mutations) :: {:ok, map} | {:error, Graphex.Error.t() | term}
  def mutate(conn, mutations), do: mutate(conn, %{}, mutations, [])

  @doc """
  The same as `Graphex.mutate(conn, "", mutations, opts)`.
  """
  ...
  Example of usage
      ...
      iex> Graphex.delete(conn, %{"uid" => "0xfe04c"})
      {:ok, %{queries: %{}, uids: %{}}}

  Using `json`

      iex> json = %{"uid" => "0xfe04c"}
           Graphex.delete(conn, json)
      {:ok, %{queries: %{}, uids: %{}}}

      iex> Graphex.delete(conn, json, return_json: true)
  ...
  @doc """
  The same as `Graphex.delete(conn, "", deletion, [])`
  """
  @spec delete(conn, statement) :: {:ok, map} | {:error, Graphex.Error.t() | term}
  def delete(conn, statement), do: mutate(conn, %{}, %{delete: statement}, [])

  @doc """
  The same as `Graphex.delete(conn, query, deletion, [])` or `Graphex.delete(conn, "", deletion, opts)`
  """
  ...
  @doc """
  Runs a mutation with delete target and returns the result or raises `Graphex.Error` if there was
  ...
  Example of usage
      ...
      iex> query = "
           ...
           "
      iex> Graphex.query(conn, query, %{"$a" => "Foo"})
  ...
  Query options (see DGraph documentation for more information):
      ...
      * `read_only` - `boolean`
  """
  @spec query(conn, iodata, map, Keyword.t()) :: {:ok, map} | {:error, Graphex.Error.t() | term}
  ...
  @doc """
  Runs a query and returns the result or raises `Graphex.Error` if there was an error.
  See `query/3`.
  """
  ...
  """
  @spec query_schema(conn) :: {:ok, map} | {:error, Graphex.Error.t() | term}
